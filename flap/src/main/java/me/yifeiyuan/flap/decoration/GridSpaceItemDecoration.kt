...
class GridItemDecoration : RecyclerView.ItemDecoration {
    ...
    private val mOrientation = RecyclerView.VERTICAL
    ...
    private fun drawVertical(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val height = if (mOrientation == RecyclerView.VERTICAL) drawable!!.intrinsicHeight else drawable!!.intrinsicWidth
        val width = if (mOrientation != RecyclerView.VERTICAL) drawable!!.intrinsicHeight else drawable!!.intrinsicWidth
